    ...
    <div className="flex items-center gap-4 mb-6">
      ...
      <div className="ml-auto flex items-center gap-2">
        <Button 
          variant="outline" 
          size="sm" 
          className="gap-2 hover:bg-cyan-50 hover:text-cyan-700 hover:border-cyan-300 transition-colors"
          onClick={onExport}
          disabled={isLoading}
        >
        ...
        <Button variant="outline" size="sm" className="gap-2 hover:text-green-600 hover:bg-green-50 hover:border-green-300 transition-colors">
...
export default function Dashboard() {
  ...
  const pp = 'https://www.pinterest.com/ideas/keyboard-typing-gif/925344991782/';
  useEffect(() => {
