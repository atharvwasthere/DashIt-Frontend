          ...
          {showPreview && (
            <div className="fade-in-up bg-white/95 backdrop-blur-xl border border-white/20 rounded-2xl p-8 shadow-2xl max-w-3xl mx-auto">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-sm text-gray-500 font-mono">dashit.com/dashboard</div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 p-4 rounded-xl border border-cyan-200">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs text-green-700 font-medium">Orders</span>
                  </div>
                  <div className="text-2xl font-bold text-green-900">876K</div>
                  <div className="text-xs text-green-600">+8.7% increase</div>
                </div>
              </div>
