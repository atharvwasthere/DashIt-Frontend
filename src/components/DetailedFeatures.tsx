      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="bg-background border border-border rounded-lg p-8">
            ...
            <div className="text-sm text-muted-foreground">
              <div className="font-semibold text-foreground">Atharv Singh</div>
              Product & UX Lead
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="order-1 lg:order-2">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-accent rounded-full mt-2"></div>
                <span className="text-muted-foreground">Minimal hallucination—if Dashit can't find it, it will tell you</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Your questions, your flow—Dashit adapts.
            </p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-background border border-border rounded-lg p-6">
              ...
              <div className="text-xs text-muted-foreground">
                <div className="font-semibold text-foreground">Rishabh Munjal</div>
