      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <Link to="#" className="block text-sm text-muted-foreground hover:text-foreground mb-2">Dashit vs. spreadsheets</Link>
            <Link to="#" className="block text-sm text-muted-foreground hover:text-foreground mb-2">Dashit vs. DIY dashboards</Link>
            <Link to="#" className="block text-sm text-muted-foreground hover:text-foreground mb-2">Dashit vs. generic chatbots</Link>
          </div>
        </div>
        ...
        <div className="border-t border-border pt-8">
          <div className="text-center">
            <p className="text-sm text-muted-foreground">
              © 2025 Dashit. All rights reserved.
            </p>
